...
api: "DELETE https://lojinha.dev/api/v1/carts/:id/products/:pid"
description: "Remove um produto do carrinho."
authMethod: "bearer"
---

<Warning>
  Ao remover um produto, se o carrinho ficar vazio ele é automáticamente
  arquivado e o endpoint retorna um status 204.
</Warning>
