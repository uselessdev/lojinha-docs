...
api: "POST https://lojinha.dev/api/v1/carts/:id/products"
description: "Adiciona uma lista de produtos em um carrinho existente."
authMethod: "bearer"
---

<Warning>
  Se o produto já existe no carrinho, é retornado um erro com status 422.
</Warning>
...

{
  ...
  "error": "The requested product already exists in cart, please change the quantity instead"
}
```
