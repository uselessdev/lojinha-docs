---
title: "Clientes"
api: "POST https://lojinha.dev/api/v1/customers"
description: "Cria um cliente"
authMethod: "bearer"
---

https://lojinha.dev não oferece autenticação de cliente, o cliente criado é útil para
relacionar pedidos e endereço apenas.
...
https://lojinha.dev/api/on-create-customer este endpoint aceita uma requisição `POST`
